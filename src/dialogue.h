...
const DialogueLine gamelines[64][64] = {
    ...
    {{SAY, 0, CH_BERYL, EMO_HAPPY1, "Oh.. This is familiar."},
     ...
     {SAY, 0, CH_BERYL, EMO_HAPPY1, "What a strange time."},
     {EXIT}},
    ...
    {{SAY, 0, CH_BERYL, EMO_HAPPY2, "If you squint your eyes.. It looks green."},
     ...
     {SAY, 0, CH_BERYL, EMO_HAPPY1, "I'd always get a piece whenever I"},
     {SAY, 0, CH_BERYL, EMO_HAPPY1, "skipped lunch that day."},
