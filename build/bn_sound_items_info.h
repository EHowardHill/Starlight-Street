...
namespace bn::sound_items_info
{
    constexpr inline pair<sound_item, string_view> array[] = {
        ...
        make_pair(sound_item(3), string_view("door")),
        make_pair(sound_item(4), string_view("footstep")),
        make_pair(sound_item(5), string_view("gasp")),
        make_pair(sound_item(10), string_view("sebenereben")),
        make_pair(sound_item(14), string_view("twinkle")),
        make_pair(sound_item(15), string_view("v_2018")),
    };
